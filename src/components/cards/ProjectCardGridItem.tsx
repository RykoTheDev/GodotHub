...
export function ProjectCardGridItem({
  ...
  return (
    <div
      ...
      className={`group relative flex flex-col rounded-item border transition-all duration-150 gap-3 p-5 ${
        selected
    ...
    >
      ...
      <div className="flex items-center gap-2 min-w-0">
        <div className="shrink-0 w-12 h-12 rounded-item bg-raised flex items-center justify-center overflow-hidden">
          {icon ? (
        ...
        <div className="flex-1 min-w-0">
          <h4 className="text-[16px] font-medium text-ink truncate">
            {displayName}
          </h4>
